...
require(['loads', 'goku', 'TiledMapBuilder-master/WebContent/tiledmapbuilder','resources/maps/map1/map','elements'],
    function(assets, goku, tiledmapbuilder, firstMap, components ) {
        ...
        var start = function(assets, goku, tiledmapbuilder, firstMap, components ) {
            ...
            Crafty.c("hasHealth", components.hasHealth);
        ...
        printbutton=function() {
            ...
            Crafty.e("2D, Canvas, Color, Mouse, Button, Text")
                .attr({x: _dbz.maxX / 2, y: _dbz.maxY / 2, w: 100, h: 40})
                .color("lightblue")
                .bind('Click', function (TouchPoint) {
                    start(assets, goku, tiledmapbuilder, firstMap, components);
                    this.destroy();
                })
                .text("Demarrer le jeu !")
